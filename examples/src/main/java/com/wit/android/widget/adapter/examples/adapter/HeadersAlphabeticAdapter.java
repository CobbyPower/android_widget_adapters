...
public class HeadersAlphabeticAdapter extends BaseMultiAdapter<HeadersAlphabeticAdapter> {
	...
	private static final int VIEW_TYPE_ITEM = 0x01;

	final List<AlphabeticHeaders.AlphabeticItem> MODELS = new ArrayList<AlphabeticHeaders.AlphabeticItem>();

	private final AlphabeticHeaders<HeadersAlphabeticAdapter> HEADERS = new AlphabeticHeaders<HeadersAlphabeticAdapter>();
